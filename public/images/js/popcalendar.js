...
//	email :	fuushikaden@yahoo.com
   ...
   function WeekNbr(n) {
	...
	function constructCalendar () {
		...
		var dateMessage
		var	fechaInicio =	new	Date (yearSelected,monthSelected,1)
		var fechaFin

		if (monthSelected==1)
		{
			fechaFin	= new Date (yearSelected,monthSelected+1,1);
			fechaFin	= new Date (fechaFin	- (24*60*60*1000));
			numDaysInMonth = fechaFin.getDate()
		}
		else
		{
		...
		datePointer	= 0
		dayPointer = fechaInicio.getDay() - startAt
		...
		if (showWeekNumber==1)
		{
			sHTML += "<td align=right>" + WeekNbr(fechaInicio) + "&nbsp;</td>"
		}
